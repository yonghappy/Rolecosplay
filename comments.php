...
<?php if ( have_comments() ) : ?>
	<h4 class="single-page-title total-comments-title"><?php comments_number(__('No Responses','mythemeshop'), __('One Response','mythemeshop'),  __('% Comments','mythemeshop') );?></h4>
	<div id="comments">
...
<?php if ('open' == $post->comment_status) : ?>
	<h4 class="single-page-title comment-respond-title">Reply</h4>
	<div id="commentsAdd">
