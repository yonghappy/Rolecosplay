...
$sections[] = array(
				...
				'fields' => array(
					array(
						'id' => 'mts_header_slider',
						'type' => 'button_set_hide_below',
						'title' => __('Header carousel', 'mythemeshop'), 
						'options' => array('0' => 'Off','1' => 'On'),
						'sub_desc' => __('<strong>Enable or Disable</strong> Header carousel with this button. The slider will show recent articles from the selected categories.', 'mythemeshop'),
						'std' => '1',
                        'args' => array('hide' => 2)
						),
						array(
						'id' => 'mts_header_slider_cat',
                        ...
                        array(
						'id' => 'mts_header_slider_num',
						'type' => 'text',
                        'class' => 'small-text',
						'title' => __('Number of posts', 'mythemeshop'), 
						'sub_desc' => __('Enter the number of posts to show in the carousel', 'mythemeshop'),
                        'std' => '10',
                    ...
                    array(
						...
						'type' => 'button_set',
						'title' => __('Header Search', 'mythemeshop'), 
						'options' => array('0' => 'Off','1' => 'On'),
						'sub_desc' => __('Use this button to enable search form in header area.', 'mythemeshop'),
						'std' => '1'
						),
					array(
                        ...
                        'subfields' => 
                            array(
                                ...
                                array(
            						...
            						'type' => 'icon_select',
                                    'allow_empty' => false,
            						'title' => __('Icon Select (demo)', 'mythemeshop'), 
                   ...
                   array(
						...
						'std' => array(
							'1' => array(
								...
								'mts_featured_category_layout' => 'column_3',
								'mts_featured_category_vert_postsnum' => '6'
							)
						)
					),
					array(
						'id' => 'mts_date_show',
						'type' => 'button_set',
						'title' => __('Date post info', 'mythemeshop'), 
						'options' => array('0' => 'Off','1' => 'On'),
						'sub_desc' => __('Do you want the Date info to appear', 'mythemeshop'),
						'std' => '1'
						),
					/* array(
						'id' => 'mts_cmnt_show',
						'type' => 'button_set',
						'title' => __('Comment post info', 'mythemeshop'), 
						'options' => array('0' => 'Off','1' => 'On'),
						'sub_desc' => __('Do you want the Comment info to appear', 'mythemeshop'),
						'std' => '1'
						), */

					array(
						'id' => 'mts_minutes_to_read',
						'type' => 'button_set_hide_below',
						'title' => __('Minutes to read', 'mythemeshop'), 
						'options' => array('0' => 'Off','1' => 'On'),
						'sub_desc' => __('Show post length in minutes on homepage and archive pages.', 'mythemeshop'),
						'std' => '1',
						'args' => array(
	        					'hide' => '4'
	        				),
                    ...
                    array(
        				'id' => 'mts_words_per_minute_min',
        				'type' => 'text',
        				'class' => 'small-text',
        				'title' => __('Words per minute MIN', 'mythemeshop') ,
        				'sub_desc' => __('Minimum value of words read per minute. Used for calculating length.', 'mythemeshop') ,
        				'std' => '100',
        				'args' => array(
	        					'type' => 'number'
	        				),
                    ...
                    array(
        				'id' => 'mts_words_per_minute_max',
        				'type' => 'text',
        				'class' => 'small-text',
        				'title' => __('Words per minute MAX', 'mythemeshop') ,
        				'sub_desc' => __('Maximum value of words read per minute. Used for calculating length.', 'mythemeshop') ,
        				'std' => '120',
        				'args' => array(
        					'type' => 'number'
	        				),
                    ...
                    array(
        				'id' => 'mts_minutes_to_read_interval_above',
        				'type' => 'text',
        				'class' => 'small-text',
        				'title' => __('Min &mdash; max interval above', 'mythemeshop') ,
        				'sub_desc' => __('Show length in <strong>min &mdash; max</strong> format if average length is above this many minutes.', 'mythemeshop') ,
        				'std' => '10',
        				'args' => array(
        					'type' => 'number'
	        				),
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id' => 'mts_tag_show',
						'type' => 'button_set',
						'title' => __('Tag post info', 'mythemeshop'), 
						'options' => array('0' => 'Off','1' => 'On'),
						'sub_desc' => __('Do you want the Tag info to appear', 'mythemeshop'),
						'std' => '1'
						),
					array(
					...
					array(
						'id' => 'mts_category_show',
						'type' => 'button_set',
						'title' => __('Category post info', 'mythemeshop'), 
						'options' => array('0' => 'Off','1' => 'On'),
						'sub_desc' => __('Organize how you want the post meta info to appear', 'mythemeshop'),
						'std' => '1'
						),
